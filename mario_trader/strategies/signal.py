...
def generate_signal(df, currency_pair, debug_mode=False):
    """
    ...
    Args:
        ...
        debug_mode: If True, relaxes some conditions for testing
    ...
    return generate_sma_crossover_signal(df, currency_pair, debug_mode) 